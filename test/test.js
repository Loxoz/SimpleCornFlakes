...
describe('SimpleCornFlakes', () => {
    ...
    it('should return a random String with a length of 16', () => {
        expect(CornFlake().length).toBe(16);
    });
